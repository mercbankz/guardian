                ...
                <div className="w-40 h-40 relative">
                  <div className="absolute inset-0">
                    <div className="w-full h-full relative">
                      ...
                      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                        {/* Central Body */}
                        <div className="w-2 h-12 bg-gradient-to-b from-cyan-400 to-blue-400 rounded-full relative">
                          {/* Body Glow */}
                          <div className="absolute inset-0 bg-gradient-to-b from-cyan-400/50 to-blue-400/50 rounded-full blur-sm"></div>
                        </div>
                        ...
                        <div className="absolute top-0 left-0 transform -translate-x-4 -translate-y-4">
                          <div className="dragonfly-wing-top-left">
                            <div className="w-8 h-3 bg-gradient-to-r from-cyan-400/80 to-transparent rounded-full transform rotate-45 origin-left"></div>
                            <div className="w-6 h-2 bg-gradient-to-r from-cyan-400/60 to-transparent rounded-full transform rotate-30 origin-left mt-1"></div>
                            <div className="w-4 h-1.5 bg-gradient-to-r from-cyan-400/40 to-transparent rounded-full transform rotate-15 origin-left mt-1"></div>
                            <div className="w-3 h-1 bg-gradient-to-r from-cyan-400/30 to-transparent rounded-full transform rotate-5 origin-left mt-1"></div>
                          </div>
                        </div>
                        ...
                        <div className="absolute top-0 right-0 transform translate-x-4 -translate-y-4">
                          <div className="dragonfly-wing-top-right">
                            <div className="w-8 h-3 bg-gradient-to-l from-cyan-400/80 to-transparent rounded-full transform -rotate-45 origin-right"></div>
                            <div className="w-6 h-2 bg-gradient-to-l from-cyan-400/60 to-transparent rounded-full transform -rotate-30 origin-right mt-1"></div>
                            <div className="w-4 h-1.5 bg-gradient-to-l from-cyan-400/40 to-transparent rounded-full transform -rotate-15 origin-right mt-1"></div>
                            <div className="w-3 h-1 bg-gradient-to-l from-cyan-400/30 to-transparent rounded-full transform -rotate-5 origin-right mt-1"></div>
                          </div>
                        </div>
